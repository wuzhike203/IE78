...
(function(window, document, undefined) {
	...
	*/
    ...
    try{
        ...
        // 2, 3, 4
        Element.prototype.addEventListener = function(eventType, funcHandle, useCapture) {
            oDomExtend.addEventListener.call(Element, eventType, funcHandle, useCapture);
        };
        Element.prototype.dispatchEvent = function(event) {
            oDomExtend.dispatchEvent.call(Element, event);
        };
        Element.prototype.removeEventListener = function() {
            oDomExtend.removeEventListener.call(Element, eventType, funcHandle, useCapture);	
        };
    }catch(e){
    }
